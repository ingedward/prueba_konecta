...
class Ventas_model extends CI_Model {
	...
	{
		$this->db->select("dt.*,p.referencia,p.nombre");
	...
	{
		$this->db->select("id,referencia,nombre as label,precio,stock");
	...
	#--- guarda los detalles del formulario de venta
	...
	{
		$this->db->where("referencia", $codigo_barra);
		$resultados = $this->db->get('productos');
		if ($resultados->num_rows() > 0) 
		{
