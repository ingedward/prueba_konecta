$(document).ready(function () {
    ...
    $(".btn-view-producto").on("click", function(){
        ...
        html = "<p><strong>Referencia:</strong>"+infoproducto[1]+"</p>"
        ...
        html += "<p><strong>Peso:</strong>"+infoproducto[7]+"</p>"
        html += "<p><strong>Categoria:</strong>"+infoproducto[6]+"</p>";
        html += "<p><strong>Fecha Creación:</strong>"+infoproducto[8]+"</p>";
    ...
    $('#stockProductos').DataTable({
       ...
       "select": {
        ...
        "aaSorting": [[5,'desc']] /* adicionado para ordenar */
    });
